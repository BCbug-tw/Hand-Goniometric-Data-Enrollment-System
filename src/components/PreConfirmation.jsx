        ...
        <div className="p-4 p-md-5">
            ...
            <div className="d-flex gap-3 mt-4 mb-3">
                <Button
                    ...
                    size="lg"
                    className="w-50 rounded-pill py-3 fw-medium"
                    onClick={onBack}
                >
                ...
                <Button
                    variant="primary"
                    size="lg"
                    className="w-50 d-flex align-items-center justify-content-center gap-2 rounded-pill py-3 shadow-sm transition-all fw-medium"
                    onClick={onNext}
                >
